...
test('Match route by method', async () => {
    ...
    await expect(router.routeRequest()).resolves.toHaveProperty('body.type', "POST")
})
...
test('Match with path parameters', async () => {
    ...
    await expect(router.routeRequest()).resolves.toHaveProperty('body.action', 'CSV')
})
...
test('Match with multiple parameters', async () => {
    ...
    await expect(router.routeRequest()).resolves.toHaveProperty('body.action', 'GET_USER_CONNECTION')
    await expect(router.routeRequest()).resolves.toHaveProperty('body.pathParameters.connectionId', '5678')
})
