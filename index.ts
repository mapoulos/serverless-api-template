...
export const proxyHandler = async (event: APIGatewayProxyEventV2 /*| ALBEvent*/): Promise<LambdaResponse> => {
    try {
        ...
        return {
            ...
            ...routerResponse,
            body: (typeof routerResponse.body === 'string') ? routerResponse.body : JSON.stringify(routerResponse.body)
        }
    } catch(error) {
